...
competing shell configuration file, parse Villain's root-level file, or persist
...
serialization and migration review in Knave, and tests for unknown and source
